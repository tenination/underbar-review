(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    for (var i = 0; i < array.length; i++) {
      if (iterator === undefined) {
        ...
        if (!transformArray.includes(iterator(array[i]))) {
          outputArray.push(array[i]);
          transformArray.push(iterator(array[i]));
        }
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    _.each(collection, function(item) {
      if (accumulator === undefined && ranOnce === false) {
        accum = collection[0];
        ranOnce = true;
      } else {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      //if arguments is contained withitn result object, then return key-value pair
      ...
      //else we interact with function
  ...
  _.shuffle = function(array) {
    var outputArray = array.slice();
    for (var i = 0; i < array.length; i++) {
      var randomNumber = Math.floor( Math.random() * array.length );
      var randomNumber2 = Math.floor( Math.random() * array.length );
      var temp1 = outputArray[randomNumber];
      var temp2 = outputArray[randomNumber2];
      console.log(temp1, temp2)
      outputArray[randomNumber] = temp2;
      outputArray[randomNumber2] = temp1;
    }
    return outputArray;
  };
